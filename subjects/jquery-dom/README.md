...
- [Feature : _"Select discussion item"_](#feature--select-discussion-item)
...
- [Feature : _"Change message alignment"_](#feature--change-message-alignment)
  ...
  - [Do you have _any_ class?](#do-you-have-any-class)
  - [Finally... change the alignment!](#finally-change-the-alignment)
  - [Complete code](#complete-code-1)
- [Feature : _"Add new message"_](#feature--add-new-message)
...
- [Feature : _"Remove messages"_](#feature--remove-messages)
